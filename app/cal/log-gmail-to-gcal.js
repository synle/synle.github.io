if (!window.gmail) {
  ...
  (function (e, t) {
          ...
          (o = at.selectors =
            {
              ...
              pseudos: {
                ...
                contains: lt(function (e) {
                  return function (t) {
                    return (
                      (t.textContent || t.innerText || a(t)).indexOf(e) > -1
                    );
                  };
                }),
                lang: lt(function (e) {
        ...
        function kt(e, t, n, i) {
          ...
          if (!i && 1 === f.length) {
            if (
              ...
              if (
                ((t = (o.find.ID(u.matches[0].replace(rt, it), t) || [])[0]),
                !t)
              )
                return n;
        ...
        if (
          ...
          while ((u = h[d++]) && !n.isPropagationStopped())
            ((n.type = d > 1 ? c : p.bindType || g),
              (s =
                (x._data(u, "events") || {})[n.type] && x._data(u, "handle")),
              s && s.apply(u, r),
              (s = l && u[l]),
              s &&
                x.acceptData(u) &&
    ...
    function sn(e, t, n) {
      var r = !0,
        ...
        o = Rt(e),
        a =
          x.support.boxSizing && "border-box" === x.css(e, "boxSizing", !1, o);
      if (0 >= i || null == i) {
        if (
          ((i = Wt(e, t, o)),
        ...
        ajax: function (e, n) {
          ...
          function k(e, n, r, i) {
            ...
            2 !== b &&
              ...
              (m = t),
              l &&
                d.trigger(c ? "ajaxSuccess" : "ajaxError", [C, p, c ? y : v]),
              g.fireWith(f, [C, N]),
              l &&
  ...
  var Gmail = function (e) {
    ...
    function r(
      e = "Migrate to new API compatible with new Gmail to silence this warning!",
    ) {
      v.DISABLE_OLD_GMAIL_API_DEPRECATION_WARNINGS ||
        console.warn("GmailJS: using deprecated API for old Gmail.", e);
    }
    ((v.DISABLE_OLD_GMAIL_API_DEPRECATION_WARNINGS = !1),
      (v.version = "0.8.0"),
      (v.tracker.globals =
        "undefined" != typeof GLOBALS ? GLOBALS : (t && t.GLOBALS) || []),
      (v.tracker.view_data =
        "undefined" != typeof VIEW_DATA ? VIEW_DATA : (t && t.VIEW_DATA) || []),
      ...
      (v.get.manager_email = function () {
        return v.helper.get.is_delegated_inbox()
          ? v.get.delegated_to_email()
          : v.get.user_email();
      }),
      (v.get.delegated_to_email = function () {
        ...
        if (n && 0 < n.length)
          for (e in n) if ((t = n[e]).index === o) return t.email;
      ...
      (v.helper.filter_locale = function (e) {
        return v.helper.get.is_locale(e)
      ...
      (v.get.storage_info = function () {
        var e = document.querySelector(".md.mj div"),
          ...
          e =
            (100 * parseFloat(t.replace(/[^0-9\.]/g, ""))) /
            parseFloat(r.replace(/[^0-9\.]/g, ""));
      ...
      (v.dom.email_subject = function () {
        for (var e = u(".hP"), t = 0; t < e.length; t++)
          if (u(e[t]).is(":visible")) return u(e[t]);
        return u();
      }),
      ...
      (v.dom.toolbar = function () {
        for (var e = u("[gh='mtb']"); 1 === u(e).children().length; )
          e = u(e).children().first();
        return e;
      }),
      (v.dom.right_toolbar = function () {
        for (
          var e = u("[gh='tm'] [gh='s']").parent();
          1 === u(e).children().length;
        )
          e = u(e).children().first();
        return e;
      }),
      (v.check.is_inside_email = function () {
        if ("email" !== v.get.current_page() && !v.check.is_preview_pane())
          return !1;
      ...
      (v.dom.email_contents = function () {
        for (
          var e = u(".ii.gt div.a3s.aXjCH"), t = [], r = 0;
          r < e.length;
          r++
        ) {
          var a = e[r].getAttribute("class").split(" ")[2],
      ...
      (v.check.is_anydo_installed = function () {
        return (
          0 <
          u("[id^='anydo'],[id*=' anydo'],[class*=' anydo'],[class*='anydo']")
            .length
        );
      }),
      (v.check.is_boomerang_installed = function () {
        return (
          0 <
          u("[id^='b4g_'],[id*=' b4g_'],[class*=' b4g_'],[class*='b4g_']")
            .length
        );
      }),
      ...
      (v.check.are_shortcuts_enabled = function () {
        for (
          var e = void 0, t = !0, r = v.tracker.globals[17][4][1], a = 0;
          a < r.length;
          a++
        ) {
          var o = r[a];
      ...
      (v.helper.get.navigation_count = function (e) {
        ...
        if ((t || 0 < t.length) && -1 !== t[0].title.indexOf(e)) {
          e = parseInt(
            t[0].attributes["aria-label"].value.replace(/[^0-9]/g, ""),
          );
          if (!isNaN(e)) return e;
        }
        return 0;
          ...
          (function (e, t) {
            ...
            var r,
              ...
              s =
                /\[/.test(i[0]) && /\]$/.test(i[s])
                  ? ((i[s] = i[s].replace(/\]$/, "")),
                    (i = i.shift().split("[").concat(i)).length - 1)
                  : 0;
            if (2 === e.length)
              if (
      ...
      (v.tools.parse_actions = function (e, t) {
        ...
        ("string" == typeof e.url.ik && (v.tracker.ik = e.url.ik),
          ...
          "string" == typeof e.url.rid &&
            -1 !== e.url.rid.indexOf("mail") &&
            (v.tracker.rid = e.url.rid));
        ...
        return (
          "string" == typeof e.url._reqid &&
            "tl" === e.url.view &&
            void 0 !== e.url.auto &&
            ((s = [e.url.th, e.url, e.body]),
            v.observe.bound("new_email") && (r.new_email = s)),
          ("cv" !== e.url.view && "ad" !== e.url.view) ||
            "string" != typeof e.url.th ||
            "string" != typeof e.url.search ||
            void 0 !== e.url.rid ||
            ((s = [e.url.th, e.url, e.body]),
            v.observe.bound("open_email") && (r.open_email = s)),
          ("cv" !== e.url.view && "ad" !== e.url.view) ||
            "object" != typeof e.url.th ||
            "string" != typeof e.url.search ||
            void 0 === e.url.rid ||
            ((s = [e.url.th, e.url, e.body]),
            v.observe.bound("toggle_threads") && (r.toggle_threads = s)),
          ("cv" !== e.url.view && "ad" !== e.url.view) ||
            "string" != typeof e.url.th ||
            "string" != typeof e.url.search ||
            void 0 === e.url.rid ||
          ...
          "string" == typeof e.url.SID &&
            ...
            ((v.tracker.SID = e.url.SID),
            (s = [e.url, e.body, n]),
            v.observe.bound("poll") && (r.poll = s)),
          "string" == typeof e.url.ik &&
            "string" == typeof e.url.search &&
            0 === e.body.length &&
            "string" == typeof e.url._reqid &&
            ((s = [e.url, e.body, n]),
            v.observe.bound("refresh") && (r.refresh = s)),
          s && a[o] && v.observe.bound(a[o]) && (r[a[o]] = s),
          "POST" !== e.method ||
            ("string" != typeof e.url.SID &&
              "string" != typeof e.url.ik &&
              "string" != typeof e.url.act) ||
            (r.http_event = [e]),
      ...
      (v.check.data.is_thread = function (e) {
        return (
          e && "object" == typeof e && e[1] && v.check.data.is_thread_id(e[1])
        );
      }),
      ...
      (v.check.data.is_email = function (e) {
        return (
          e && "object" == typeof e && e[1] && v.check.data.is_email_id(e[1])
        );
      }),
      ...
      (v.check.data.is_action = function (e) {
        return (
          v.check.data.is_first_type_action(e) ||
          v.check.data.is_second_type_action(e)
        );
      }),
      ...
      (v.tools.get_action = function (e) {
        return (
          v.tools.get_first_type_action(e) || v.tools.get_second_type_action(e)
        );
      }),
      ...
      (v.tools.check_event_type = function (e) {
        ...
        if (e && v.check.data.is_action(e)) {
          ...
          return r.startsWith("^x_") && v.check.data.is_first_type_action(e)
            ? t["^x_"]
            : t[r];
        }
        return null;
      ...
      (v.tools.check_fd_attachment_url = function (e) {
        ...
        return (e =
          e && t && e.indexOf(t) < 0 ? e.replace("/mail/?", t + "?") : e);
      }),
        ...
        try {
          ...
          for (t of e) {
            ...
            for (r of t[3]) {
              ...
              (v.cache.debug_xhr_fetch &&
                ((b.$email_node = r), (b.$thread_node = t)),
                g.push(b));
            }
          }
          return g;
        ...
        try {
          ...
          for (t of e) {
            ...
            for (r of t[1][5]) {
              ...
              (v.cache.debug_xhr_fetch &&
                ((_.$email_node = r), (_.$thread_node = t)),
                u.push(_));
            }
          }
          return u;
              ...
              for (var s in o) {
                ...
                v.check.data.is_smartlabels_array(e) &&
                  ...
                  -1 !== e.indexOf("^pfg")
                    ...
                    : -1 < e.indexOf("^scheduled") &&
                      (r.send_scheduled_message = [t.url, t.body, s]));
              }
            try {
              if (Array.isArray(u) && v.check.data.is_thread(u[0])) {
                ...
                if (l) {
                  ...
                  var c = u.map((e) => v.tools.get_thread_id(e)),
                    d = _.map((e) => v.tools.get_message_ids(e)).reduce(
                      (e, t) => e.concat(t),
                      [],
                    );
      ...
      (v.tools.parse_response = function (t) {
        ...
        if (
          ...
          -1 !== t.indexOf("display:inline-block")
        )
          return [];
        let r = [];
        try {
          for (
            ...
            var a = parseInt(e, 10) - 2 + t.indexOf("["),
              ...
              n = JSON.parse(o);
            (r.push(n),
              (t = (t = t.substring(t.indexOf("["), t.length)).substring(
                o.length,
                t.length,
              )));
          }
    ...
    ((v.tools.parse_requests = function (e, t) {
        ...
        if (null !== e) {
          ...
          for (let t of e) {
            (void 0 === o.emailIdCache[t.id] || r) &&
              ((o.emailIdCache[t.id] = t),
              (o.emailLegacyIdCache[t.legacy_email_id] = t));
            let e = o.threadCache[t.thread_id];
            var a;
            (e ||
              ((e = { thread_id: t.thread_id, emails: [] }),
              (o.threadCache[t.thread_id] = e)),
              0 === e.emails.filter((e) => e.id === t.id).length
                ? e.emails.push(t)
                : r &&
                  ((a = e.emails.findIndex((e) => e.id === t.id)),
                  (e.emails[a] = t)));
          }
        }
      }),
        ...
        if (!v.tracker.xhr_init) {
          ...
          (v.tools.patch(e.XMLHttpRequest.prototype.open, (i) => {
            e.XMLHttpRequest.prototype.open = function (e, t, r, a, o) {
              ...
              return (
                (this.xhrParams = { method: e.toString(), url: t.toString() }),
                n
              );
            };
          }),
            v.tools.patch(e.XMLHttpRequest.prototype.send, (n) => {
              e.XMLHttpRequest.prototype.send = function (e) {
                ...
                (this.xhrParams &&
                  ...
                  (o = v.tools.parse_requests(this.xhrParams, this))),
                  v.observe.trigger("before", o, this) &&
                    (e = v.check.is_new_data_layer()
                      ...
                      : (arguments[0] = this.xhrParams.body_is_object
                          ? this.xhrParams.body_params
                          : u
                              .param(this.xhrParams.body_params, !0)
                              .replace(/\+/g, "%20"))),
                  (v.observe.bound(o, "after") ||
                    ...
                    ((a = this).onreadystatechange = function (e) {
                      ...
                      (this.readyState === this.DONE &&
                        ...
                        "text" === e.target.responseType
                          ? (a.xhrResponse = v.tools.parse_response(
                              e.target.responseText,
                            ))
                          : (a.xhrResponse = e.target.response),
                        v.check.is_new_data_layer() &&
                          (!v.tools
                            .get_pathname_from_url(a.xhrParams.url_raw)
                            .endsWith("/i/fd") ||
                            (null !=
                              (t = v.tools.parse_fd_request_payload(
                                a.xhrResponse,
                              )) &&
                              (v.tools.cache_email_data(
                                t,
                                "fd_request_payload",
                              ),
                              (o.load_email_data = [t]))),
                          !v.tools
                            ...
                            .endsWith("/i/bv") ||
                            (null !=
                              (t = v.tools.parse_bv_request_payload(
                                a.xhrResponse,
                              )) &&
                              (v.tools.cache_email_data(
                                t,
          ...
          (window._GM_setData = function (e) {
            ...
            (void 0 !== e &&
              ...
              void 0 !== e &&
                void 0 !== e.a6jdv &&
                void 0 !== e.a6jdv[0][2] &&
                ((t = v.tools.parse_bv_embedded_json(
                  JSON.parse(e.a6jdv[0][2]),
                )),
      ...
      (v.helper.get_xhr_window = function () {
        ...
        return (
          ...
          (e = e || (t ? t.top : top)).contentDocument
      ...
      (v.observe.bind = function (e, t, r) {
        ("object" != typeof v.tracker.watchdog &&
          ((v.tracker.watchdog = { before: {}, on: {}, after: {}, dom: {} }),
          (v.tracker.bound = {})),
          "object" != typeof v.tracker.watchdog[e] &&
            v.tools.error("api.observe.bind called with invalid type: " + e),
          "dom" !== e && v.tools.xhr_watcher(),
          "object" != typeof v.tracker.watchdog[e][t] &&
            (v.tracker.watchdog[e][t] = []),
          v.tracker.watchdog[e][t].push(r),
          (v.tracker.bound[t] =
            void 0 === v.tracker.bound[t] ? 1 : v.tracker.bound[t] + 1),
          (v.tracker.bound[e] =
            void 0 === v.tracker.bound[e] ? 1 : v.tracker.bound[e] + 1));
      }),
        ...
        ((v.tracker.dom_observer_init = !0),
          ...
          (v.tracker.dom_observers = {
            ...
            recipient_change: {
              ...
              handler: function (e, r) {
                ("object" != typeof v.tracker.recipient_matches &&
                  (v.tracker.recipient_matches = []),
                  v.tracker.recipient_matches.push(e),
                  setTimeout(function () {
                    var e, t;
                    v.tracker.recipient_matches.length &&
                      ((t = (e = new v.dom.compose(
                        v.tracker.recipient_matches[0].closest("div.M9"),
                      )).recipients()),
              ...
              handler: function (e, t) {
                ...
                (e = e.closest("div.M9")).length &&
                  ((e = new v.dom.compose(e)).is_inline()
                    ? (r =
                        0 === e.find("input[name=subject]").val().indexOf("Fw")
                          ? "forward"
                          : "reply")
                    : ((r = "compose"),
                      a
                        ...
                        .mouseup(function () {
                          return (
                            v.tracker.composeCancelledCallback &&
                              v.tracker.composeCancelledCallback(e),
                            !0
                          );
                        })),
                  t(e, r));
          ...
          v.tracker.custom_supported_observers &&
            ...
            u.extend(
              !0,
              v.tracker.dom_observers,
              v.tracker.custom_dom_observers,
            )),
    ...
    ((v.observe.on_dom = function (e, t) {
        ...
        return (
          v.tracker.observing_dom ||
            ...
            new MutationObserver(function (e) {
              for (var t = 0; t < e.length; t++)
                for (
                  var r, a, o = e[t], n = o.removedNodes, i = 0;
                  i < n.length;
                  i++
                )
                  "vR" === n[i].className &&
      ...
      (v.tools.insertion_observer = function (n, i, s, e) {
        var t;
        v.tracker.dom_observer_map &&
          ((t = (t = n.className || "").trim ? t.trim().split(/\s+/) : [])
            .length || t.push(""),
      ...
      (v.tools.parse_view_data = function (e) {
        for (var t = [], r = [], a = 0; a < e.length; a++)
          if ("tb" === e[a][0])
            for (var o = 0; o < e[a][2].length; o++) r.push(e[a][2][o]);
          ...
          0 === t.indexOf("label/")
            ...
            : 0 === t.indexOf("category/")
              ...
              : 0 === t.indexOf("search/")
                ...
                : "inbox" === t
                  ? "true" ===
                    u("div[aria-label='Social']").attr("aria-selected")
                    ? (r +=
                        "&cat=^smartlabel_" +
                        (o = "social") +
                        "&search=category")
                    : "true" ===
                        u("div[aria-label='Promotions']").attr("aria-selected")
                      ? (r +=
                          "&cat=^smartlabel_" +
                          (o = "promo") +
                          "&search=category")
                      : "true" ===
                          u("div[aria-label='Updates']").attr("aria-selected")
                        ? (r +=
                            "&cat=^smartlabel_" +
                            (o = "notification") +
                            "&search=category")
                        : "true" ===
                            u("div[aria-label='Forums']").attr("aria-selected")
                          ? (r +=
                              "&cat=^smartlabel_" +
                              (o = "group") +
                              "&search=category")
          ...
          v.check.is_inside_email()
            ...
            : u("[gh='tl'] div[role='checkbox'][aria-checked='true']").length &&
              ...
              u("[gh='tl'] div[role='checkbox']").each(function (e) {
                "true" === u(this).attr("aria-checked") &&
                  ((t = v.get.email_data(r[e].id)), a.push(t));
              })),
          a
        );
      }),
      (v.get.current_page = function (e) {
        e =
          (e = e || window.location.hash).split("#").pop().split("?").shift() ||
          "inbox";
        if (e.match(/\/[0-9a-zA-Z]{16,}$/gi)) return "email";
        if (
          0 !== e.indexOf("search/") &&
          0 !== e.indexOf("category/") &&
          0 !== e.indexOf("label/")
        )
        ...
        for (t in e) {
          ...
          if (
            ...
            (void 0 === r.threads && (r.threads = {}),
              ...
              (r.threads[a[1]].attachments_details = a[13]
                ? v.tools.parse_attachment_data(a[13])
                : null),
              (r.threads[a[1]].subject = a[12]),
              (r.threads[a[1]].content_html = a[13] ? a[13][6] : a[8]),
              (r.threads[a[1]].to = a[13]
                ? a[13][1]
                : void 0 !== a[37]
                  ? a[37][1]
                  : []),
      ...
      (v.helper.get.email_data_pre = function (e) {
        ...
        return (t =
          void 0 !==
          (e =
            v.check.is_inside_email() && void 0 === e ? v.get.thread_id() : e)
            ? window.location.origin +
              window.location.pathname +
              "?ui=2&ik=" +
              v.tracker.ik +
      ...
      (v.helper.get.legacy_email_id = function (e) {
        ...
        return (e = e.$el && e.$el[0] ? e.$el[0] : e).dataset &&
      ...
      (v.helper.get.new_email_id = function (t) {
        ...
        if (
          (t = t.$el && t.$el[0] ? t.$el[0] : t).dataset &&
          t.dataset.messageId
        ) {
    ...
    var a = function (e) {
        ...
        for (t in a) {
          var i = a[t];
          (n ? i.is_deleted : !i.is_deleted) ||
            (delete a[t], o.splice(o.indexOf(t), 1), r.total_emails--);
        }
        return r;
      },
      n = function (e) {
        ...
        for (t in e.threads)
          if (
            document.querySelector("div[data-legacy-message-id='" + t + "']")
          ) {
            var a = e.threads[t];
            ((r.first_email = t),
              (r.last_email = t),
    ...
    ((v.check.is_conversation_view = function () {
      if (v.check.is_new_data_layer())
        return -1 !== v.tracker.globals[24].indexOf(7164);
      for (
        var e = void 0, t = v.tracker.globals[17][4][1], r = 0;
        r < t.length;
        r++
      ) {
        var a = t[r];
    ...
    return (
      ...
      (v.dom.visible_messages = function () {
        const n = [];
        return (
          u('tbody>tr.zA[role="row"]:visible', v.dom.inbox_content()).each(
            (e, t) => {
      ...
      e(v.dom.compose.prototype, {
        ...
        recipients: function (r) {
          var e = (r = "object" != typeof r ? {} : r).type
              ? "[name=" + r.type + "]"
              : "",
            a = r.flat ? [] : { to: [], cc: [], bcc: [] };
          return (
            this.$el.find(".GS input[type=hidden]" + e).each(function (e, t) {
              r.flat
                ? a.push(t.value)
                : (a[t.name] || (a[t.name] = []), a[t.name].push(t.value));
            }),
            a
          );
        },
        ...
        dom: function (e) {
          ...
          return (
            t[e] ||
              v.tools.error(
                'Dom lookup failed. Unable to find config for "' + e + '"',
                t,
                e,
                t[e],
              ),
              ...
              : "string" == typeof e && v.check.data.is_email_id(e)
                ? ((t = document.querySelector(
                    "div.adn[data-message-id='" +
                      e.replace("msg-f:", "\\#msg-f\\:") +
                      "']",
                  )),
                  (this.id = t.dataset.legacyMessageId),
                  (this.$el = u(t)))
                : e &&
                    ((e.classList && e.classList.contains("adn")) ||
                      (e.hasClass && e.hasClass("adn")))
                  ? ((this.$el = u(e)),
                    (this.id = this.$el.data("legacyMessageId")))
                  : v.tools.error(
                      "api.dom.email called with invalid element/id",
                    ),
            this);
        var t;
      }),
        ...
        attachments: function () {
          ...
          return (
            this.dom("attachments").each(function () {
              ...
              (e &&
                ((e = v.tools.parse_attachment_url(e)),
                (t.url = e.url),
                (t.type = e.type)),
                r.push(t));
            }),
      ...
      (v.dom.thread = function (e) {
        return this.constructor !== v.dom.thread
          ? new v.dom.thread(e)
          : ((e && e.hasClass("if")) ||
              v.tools.error("api.dom.thread called with invalid element/id"),
            (this.$el = e),
            this);
      }),
...
async function logEventToCalendar() {
  try {
    ...
    const dateFrom = moment(emailDom.data().timestamp).format(
      DATE_TIME_FORMAT_TO,
    );
    const dateTo = moment(emailDom.data().timestamp)
      .add(1, "hours")
...
if (!document.querySelector("#btnLogToEvent")) {
  const btns = [...document.querySelectorAll("div")].filter(
    (r) => r.innerText.trim() === "More",
  );
  const btn = btns[btns.length - 1];
  if (btn) {
    btn.insertAdjacentHTML(
      "afterend",
      `<button id='btnLogToEvent'>Log to Event</button>`,
    );
    document
      .querySelector("#btnLogToEvent")
      .addEventListener("click", () => logEventToCalendar());
  }
}
