  ...
  `
    ...
    function NavReadContainer(props) {
      ...
      useEffect(() => {
        ...
        let rawLinkHTML = lines.forEach((link) => {
          ...
          if (link.trim().indexOf(FAV_ICON_SPLIT) === 0) {
            ...
            newDoms.push(React.createElement('h1', { className: 'title' }, headerText));
          } else if (link.trim().indexOf(HEADER_SPLIT) === 0) {
            // section header
            const headerText = link.replace(HEADER_SPLIT, '').trim();
            newDoms.push(React.createElement('h2', { className: 'header' }, headerText));
              ...
              .forEach((t) => {
                ...
                if (tabName && tabId) {
                  tabContent.push(
                    React.createElement(
                      'tab',
                      { tabIndex: '0', 'data-tab-id': tabId.trim() },
                      tabName.trim(),
                    ),
                  );
                }
              });
            newDoms.push(React.createElement('tabs', { className: 'tabs' }, tabContent));
          } else {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          { id: 'fav', ref: refContainer },
          doms,
          React.createElement(
            'form',
            { id: 'searchForm', onSubmit: (e) => onSubmitNavigationSearch(e) },
            React.createElement(SearchBox, { onSearch: onSearch }),
          ),
          React.createElement(
            'datalist',
            { id: 'autocompleteSearches' },
            autocompleteSearches.map((search) =>
              React.createElement('option', { key: search }, search),
            ),
          ),
        ),
        React.createElement(
    ...
    function NavEditContainer(props) {
      ...
      return React.createElement(
        ...
        React.createElement(
          'div',
          null,
          React.createElement('h1', { className: 'title' }, 'Navigation Form'),
        ),
        React.createElement(
          'div',
          ...
          React.createElement(
            'div',
            { className: 'dropdown' },
            React.createElement('a', { className: 'dropdown-trigger' }, 'Actions'),
            React.createElement(
              'div',
              ...
              React.createElement(
                ...
                {
                  target: '_blank',
                  href: 'https://synle.github.io/link/nav-generator.html?newNav',
                },
                'New',
              ),
              React.createElement(
              ...
              React.createElement('button', { type: 'button', onClick: () => onTest() }, 'Test'),
            ),
          ),
        ),
    ...
    function NavCreateContainer(props) {
      const { schema, onSetViewMode, onSetSchema } = props;
      return React.createElement(React.Fragment, null, 'create ', schema);
    }
    ...
    function App(props) {
      ...
      switch (view) {
        case 'read':
          return React.createElement(NavReadContainer, Object.assign({}, allProps));
        case 'edit':
          return React.createElement(NavEditContainer, Object.assign({}, allProps));
        case 'create':
          return React.createElement(NavCreateContainer, Object.assign({}, allProps));
      }
    }
    // initialization
    ...
    if (window.fetchSchemaScript) {
      try {
        schemaFromScript = yield window.fetchSchemaScript();
      } catch (err) {}
    } else {
      try {
    ...
    ReactDOM.render(
      React.createElement(App, { schemaFromScript: schemaFromScript }),
      document.body,
    );
  }))();
