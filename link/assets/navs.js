...
window.prompt = (promptText, promptInput, autoDismiss) => {
  ...
  return new Promise((resolve) => {
    document.body.insertAdjacentHTML(
      "beforeend",
      `
        <div id='promptModal' tabindex='0' style="display: flex; flex-direction: column; align-items:center; justify-content: center; transition: all 0.4s ease-out; position: fixed; background: rgba(225, 225, 225, 0.4); color: #fff; top: 0px; left: 0px; right: 0px; bottom: 0px; text-align: center; font-weight: bold; border: 2px solid #eee; padding: 2rem 3rem; z-index: 1;">
